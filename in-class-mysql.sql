...
CREATE USER 'andieyip'@'localhost' IDENTIFIED BY 'admin1234';

ALTER USER 'andieyip'@'localhost' IDENTIFIED BY 'andie1234';
...
-- alter table customer modify column cust_email_addr varchar(10); -- shorten length from 50 to 10, error, because some existing data's length > column definition
